...
urlpatterns = [
    ...
    path('admin-analysis-attendance/<str:cl>', views.admin_analysis_attendance_view,name='admin-analysis-attendance'),
    ...
    path('teacher-analysis-attendance/<str:cl>', views.teacher_analysis_attendance_view,name='teacher-analysis-attendance'),
